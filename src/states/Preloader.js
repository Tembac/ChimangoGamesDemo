...
export default class extends Phaser.State
{
  preload ()
  {
    ...
    this.load.atlasJSONArray("playerAtlas", "assets/textures/atlasPlayer.png", "assets/textures/atlasPlayer.json");
