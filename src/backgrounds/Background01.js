...
export default class extends Phaser.Group
{
  constructor (game)
  {
    ...
    this.backgroundLyr01 = this.game.add.sprite(0, 0, "level", "cielo01");
    this.backgroundLyr01.width = this.game.width;
    // this.backgroundLyr02 = this.game.add.sprite(0, this.game.world.height - 320, "level", "montanas");
    // this.backgroundLyr02.width = this.game.width;
